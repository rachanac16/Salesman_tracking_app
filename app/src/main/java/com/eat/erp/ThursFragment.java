...
public class ThursFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            day_route.setVisibility(View.GONE);
            if(!t.equals("Monday")&&!t.equals("Tuesday")&&!t.equals("Wednesday")){
            ...
            //Toast.makeText(getContext(),distributorname,Toast.LENGTH_LONG).show();
        ...
        new Thread() {
            public void run() {
                ...
                if (txtcheckin.getText().toString().toUpperCase().equals("CHECKIN")) {
                    ...
                    myIntent.putExtra("frequency", "Thursday");
    ...
    public String  getbeat(String day)  throws UnsupportedEncodingException
    {
        ...
        data += "&" + URLEncoder.encode("frequency", "UTF-8")
                + "=" + URLEncoder.encode("Thursday", "UTF-8");
