...
/**
 */
public class TuesFragment extends Fragment implements
...
LinearLayout day_route=view.findViewById(R.id.day_route);
        ...
        try {
            ...
            int day1 = calendar2.get(Calendar.DAY_OF_WEEK);
            if (day1 == Calendar.TUESDAY) {
                String respdata = getdashdata();
                JSONArray obj1 = new JSONArray(respdata);
    ...
    public String  getbeat(String day)  throws UnsupportedEncodingException
    {
        ...
        data += "&" + URLEncoder.encode("frequency", "UTF-8")
                + "=" + URLEncoder.encode("Tuesday", "UTF-8");
