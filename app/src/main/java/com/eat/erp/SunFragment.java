...
/**
 */
public class SunFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            if (response.equals("")) {
                ...
                response = getbeat("" + days2[6]);
                session.setsun_frag(response);
            ...
            /*String unplanned_count = obj.getString("unplanned_count");
            String p_call = obj.getString("p_call");
            String actual_count = obj.getString("actual_count");
    ...
    public String  getbeat(String day)  throws UnsupportedEncodingException
    {
        ...
        data += "&" + URLEncoder.encode("frequency", "UTF-8")
                + "=" + URLEncoder.encode("Sunday", "UTF-8");
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                if (txtcheckin.getText().toString().toUpperCase().equals("CHECKIN")) {
                    ...
                    myIntent.putExtra("frequency", "Sunday");
