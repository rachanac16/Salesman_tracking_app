...
int minteger=0, minteger1 = 0, minteger2 = 0, minteger3 = 0, minteger4 = 0, minteger5 = 0, minteger6 = 0, minteger7 = 0, minteger8 = 0, minteger9 = 0, minteger10 = 0, minteger11 = 0, minteger12 = 0, minteger13 = 0, minteger14 = 0, minteger15 = 0, minteger16 = 0, minteger17 = 0, minteger18 = 0, minteger19 = 0, minteger20 = 0;
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        if(groupPosition==0) {
            if (childPosition == 0){
                if (OrdersData.orange_bar != null) {
                    txtListChild1.setText(OrdersData.orange_bar);
                }
            }
            if(childPosition==1) {
                if(OrdersData.butterscotch_bar!=null) {
                    txtListChild1.setText(OrdersData.butterscotch_bar);
                }
            }
            if(childPosition==2) {
                if(OrdersData.chocopeanut_bar!=null) {
                    txtListChild1.setText(OrdersData.chocopeanut_bar);
                }
            }
            if(childPosition==3) {
                if(OrdersData.bambaiyachaat_bar!=null) {
                    txtListChild1.setText(OrdersData.bambaiyachaat_bar);
                }
            }
            if(childPosition==4) {
                if(OrdersData.mangoginger_bar!=null) {
                    txtListChild1.setText(OrdersData.mangoginger_bar);
                }
            }
            if(childPosition==5) {
                if(OrdersData.berry_blast_bar!=null) {
                    txtListChild1.setText(OrdersData.berry_blast_bar);
                }
            }
            if(childPosition==6) {
                if(OrdersData.chyawanprash_bar!=null) {
                    txtListChild1.setText(OrdersData.chyawanprash_bar);
                }
            }
        }
        if(groupPosition==1) {
            if(childPosition==0) {
                if(OrdersData.orange_box!=null) {
                    txtListChild1.setText(OrdersData.orange_box);
                }
            }
            if(childPosition==1) {
                if(OrdersData.butterscotch_box!=null) {
                    txtListChild1.setText(OrdersData.butterscotch_box);
                }
            }
            if(childPosition==2) {
                if(OrdersData.chocopeanut_box!=null) {
                    txtListChild1.setText(OrdersData.chocopeanut_box);
                }
            }
            if(childPosition==3) {
                if(OrdersData.bambaiyachaat_box!=null) {
                    txtListChild1.setText(OrdersData.bambaiyachaat_box);
                }
            }
            if(childPosition==4) {
                if(OrdersData.mangoginger_box!=null) {
                    txtListChild1.setText(OrdersData.mangoginger_box);
                }
            }
            if(childPosition==5) {
                if(OrdersData.berry_blast_box!=null) {
                    txtListChild1.setText(OrdersData.berry_blast_box);
                }
            }
            if(childPosition==6) {
                if(OrdersData.chyawanprash_box!=null) {
                    txtListChild1.setText(OrdersData.chyawanprash_box);
                }
            }
            if(childPosition==7) {
                if(OrdersData.variety_box!=null) {
                    txtListChild1.setText(OrdersData.variety_box);
                }
            }
        }
        if(groupPosition==2) {
            if(childPosition==0) {
                if(OrdersData.chocolate_cookies_box!=null) {
                    txtListChild1.setText(OrdersData.chocolate_cookies_box);
                }
            }
            if(childPosition==1) {
                if(OrdersData.dark_chocolate_cookies_box!=null) {
                    txtListChild1.setText(OrdersData.dark_chocolate_cookies_box);
                }
            }
            if(childPosition==2) {
                if(OrdersData.cranberry_cookies_box!=null) {
                    txtListChild1.setText(OrdersData.cranberry_cookies_box);
                }
            }
        }
        if(groupPosition==3) {
            if(childPosition==0) {
                if(OrdersData.cranberry_orange_box!=null) {
                    txtListChild1.setText(OrdersData.cranberry_orange_box);
                }
            }
            if(childPosition==1) {
                if(OrdersData.fig_raisins_box!=null) {
                    txtListChild1.setText(OrdersData.fig_raisins_box);
                }
            }
            if(childPosition==2) {
                if(OrdersData.papaya_pineapple_box!=null) {
                    txtListChild1.setText(OrdersData.papaya_pineapple_box);
                }
            }
        }
        return convertView;
