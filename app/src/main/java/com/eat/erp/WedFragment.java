 ...
 */
public class WedFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            if(!t.equals("Monday")&&!t.equals("Tuesday")){
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                if (txtcheckin.getText().toString().toUpperCase().equals("CHECKIN")) {
                    ...
                    myIntent.putExtra("frequency", "Wednesday");
    ...
    public String  getbeat(String day)  throws UnsupportedEncodingException
    {
        ...
        data += "&" + URLEncoder.encode("frequency", "UTF-8")
                + "=" + URLEncoder.encode("Wednesday", "UTF-8");
    ...
    public void onButtonClickListner1(final View convertView, int position, final String value) {
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                Toast.makeText(getContext(),txtlat.getText().toString(),Toast.LENGTH_LONG).show();
